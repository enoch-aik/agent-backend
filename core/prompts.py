# I am working on prompts for 6 implmentations of the chat model.
...
# technicalPrototypePrompt = SystemMessage(
#     content ="I want you to act as a senior game developer "
#     "who specializes in rapid prototyping and engine-level problem-solving.  I will "
#     "describe a game mechanic or idea, and your task is to "
#     "evaluate the feasibility of a game concept by analyzing technical requirements,"
#     " identifying skill required in the design and development team, and recommend tools/"
#     "engines and your role is to evaluate its technical feasibility. "
# )


controlledGameTestingPrompt = SystemMessage(content ="I want you to act as a usability test "
...
mockReviewPrompt = SystemMessage(content ="I want you to act as a seasoned game reviewer with "
...
conferencePitchingPrompt = SystemMessage(content ="I want you to act as a game startup mentor "
...
socialMediaManagementPrompt = SystemMessage(content ="I want you to act as a social media "
"strategist and content creator. Based on the game’s theme or stage of development,"
...
earlyVerticalSlicePrompt = SystemMessage(content ="I want you to act as a product strategist for"
